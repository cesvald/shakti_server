...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { body: @phrase.body, body_image: @phrase.body_image, post_on: @phrase.post_on } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { body: @phrase.body, body_image: @phrase.body_image, post_on: @phrase.post_on } }
