...
class HeadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create header" do
    assert_difference('Header.count') do
      post headers_url, params: { header: { expire_on: @header.expire_on, image: @header.image, post_on: @header.post_on } }
    end
  ...
  test "should update header" do
    patch header_url(@header), params: { header: { expire_on: @header.expire_on, image: @header.image, post_on: @header.post_on } }
